 ...
 * - $products (array):     An array of products to display, filtered by category or showing all. Each product should have 'product_id', 'name', 'price', 'image_path', 'slug'. Defaults to empty array.
